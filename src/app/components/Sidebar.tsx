...
export default function Sidebar(
  ...
  return (
    <aside className="w-[400px] bg-gray-900 h-[calc(100vh-100px)] mt-[30px] flex flex-col p-4 gap-3 rounded-r-xl translate-x-0 z-10 max-md:-translate-x-full max-md:fixed"
      style={styles}
    >
